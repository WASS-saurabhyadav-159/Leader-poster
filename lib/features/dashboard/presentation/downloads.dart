  ...
  Future<void> fetchBanners() async {
    ...
    try {
      ...
      if (e.type == DioExceptionType.connectionError) {
        showErrorPopup(context, "No internet connection. Please check your network.", fetchBanners);
      } else if (e.response?.statusCode == 404) {
        showErrorPopup(context, "Internal Error. Please try again later.", fetchBanners);
      } else {
